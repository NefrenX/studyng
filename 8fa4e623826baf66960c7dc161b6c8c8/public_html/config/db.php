...
$db   = 'x98343hs_skald'; // Имя базы данных (из панели MySQL)
$user = 'x98343hs_skald'; // Имя пользователя (часто совпадает с именем БД)
$pass = '123890Sklad'; // Пароль, который вы задали при создании БД
